...
export const Footer: React.FC<FooterProps> = ({
    ...
    return (
        <footer className="bg-[#0c72b8] pt-16 text-white pb-8 shadow-[0_-10px_25px_rgba(12,114,184,0.25)]">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 items-start">
                {/* Brand Column */}
                ...
                <div className="flex flex-col gap-3">
                    ...
                    >
                        {language === 'en' ? 'Explore Committees' : 'समितिहरू हेर्नुहोस्'}
                    </button>
                </div>
